...
const features = [
  ...
  },
  {
    ...
    header: "Geo-Tracking for Field Sales",
    description:
      "Track your team's networking and sales activity across different locations with real-time geographic insights. Identify high-performing regions, optimize field team coverage, and uncover new business opportunities through location-based analytics. Make smarter decisions with data that helps improve productivity, territory planning, and overall sales performance.",
  },
  {
    image: "/videos/steps/Motion-6.webm",
    header: "Advanced Lead Auto-Routing",
    description:
      "Automatically route incoming leads to the right team members based on predefined rules, departments, or territories. Eliminate manual lead assignment, accelerate response times, and ensure every opportunity reaches the right person for faster follow-ups and higher conversion potential.",
  },
];
    ...
    >
      ...
      <div className="w-full flex flex-col items-center text-center max-w-4xl">
        ...
        <p className="text-[var(--color-body-copy-3)] text-sm md:text-lg font-[600] leading-relaxed max-w-3xl">
          You can create, customize and track your Card very efficiently. You
          can Also Manage tasks and Organize teams and work them through our CRM
          system.
        </p>
      </div>
...
export default Corporate_Features;
