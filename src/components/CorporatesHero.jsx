...
const CorporatesHero = () => {
  return (
    <section className="w-full max-w-[1440px] px-6 md:px-14 py-12 md:py-20 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-16 bg-white relative font-plus-jakarta">
      ...
      <div className="flex-1 text-center md:text-left flex flex-col items-center md:items-start max-w-xl z-10">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-[56px] md:leading-[1.15] font-bold text-[var(--color-body-copy-4)] tracking-tight mb-6">
          Your Business Card, Reinvented For The{" "}
          <span className="text-[var(--color-primary)] block">
            Digital Age.
          </span>
        </h1>
      ...
      {/* Right Column: Image */}
      <div className="flex-1 w-full max-w-6xl flex justify-center md:justify-end z-10">
        <img
          src="/images/about-us.png"
          alt="Corporates & Teams Illustration"
