...
const Section_9 = () => {
  ...
  return (
    <section id="faq" className="w-full bg-white py-16 md:py-24 mb-20 px-4 flex flex-col items-center font-plus-jakarta z-10 relative scroll-mt-20 md:scroll-mt-24">
      {/* Badge */}
